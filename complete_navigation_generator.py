#!/usr/bin/env python3
"""
Complete script to generate navigation JSON files for ALL medical specialties
...
# Complete specialty data extracted from Index.md files
SPECIALTY_DATA = {
    'cardiology': {
...
# Generate navigation files for sample specialties first
